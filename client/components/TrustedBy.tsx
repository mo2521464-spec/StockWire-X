...
export const TrustedByWithData: React.FC = () => {
  const mockLogos: CompanyLogo[] = [
    ...
    // Standard tier (smaller)
    {
      id: "11",
      name: "REA Group",
      logoUrl: "/images/logo11.jpg",
      tier: "standard",
    },
    {
      id: "12",
      name: "Xero",
      logoUrl: "/images/logo12.jpg",
      tier: "standard",
    },
    {
      id: "13",
      name: "Afterpay",
      logoUrl: "/images/logo13.jpg",
      tier: "standard",
    },
    {
      id: "14",
    ...
    },
    {
      id: "15",
      name: "JB Hi-Fi",
      logoUrl: "/images/logo15.jpg",
      tier: "standard",
    },
    {
      id: "16",
      name: "Harvey Norman",
      logoUrl: "/images/logo16.jpg",
      tier: "standard",
    },
    {
      id: "17",
      name: "Flight Centre",
      logoUrl: "/images/logo17.jpg",
      tier: "standard",
    },
    {
      id: "18",
      name: "Cochlear",
      logoUrl: "/images/logo18.jpg",
      tier: "standard",
    },
    {
      id: "19",
      name: "Sonic Healthcare",
      logoUrl: "/images/logo19.jpg",
      tier: "standard",
    },
    {
      id: "20",
      name: "TPG Telecom",
      logoUrl: "/images/logo20.jpg",
      tier: "standard",
    },
    {
      id: "21",
      name: "Medibank",
      logoUrl: "/images/logo21.jpg",
      tier: "standard",
    },
    {
      id: "22",
      name: "Aurizon",
      logoUrl: "/images/logo22.jpg",
      tier: "standard",
    },
  ];
